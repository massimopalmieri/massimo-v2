			...
			>
				<ListboxSelectedOption
					...
					className={clsx([
						...
						'min-h-11 sm:min-h-9',
						// Horizontal padding
						'pl-[calc(calc(var(--spacing)*3.5)-1px)] pr-[calc(calc(var(--spacing)*7)-1px)] sm:pl-[calc(calc(var(--spacing)*3)-1px)]',
						// Typography
			...
			{({selectedOption}) => {
				...
				return (
					<div
						className={clsx(
							// Basic layout
							'group/option grid cursor-default grid-cols-[calc(var(--spacing)*5)_1fr] items-baseline gap-x-2 rounded-lg py-2.5 pl-2 pr-3.5 sm:grid-cols-[calc(var(--spacing)*4)_1fr] sm:py-1.5 sm:pl-1.5 sm:pr-3',
							// Typography
